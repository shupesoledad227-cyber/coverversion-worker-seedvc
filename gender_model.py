# Vendored from https://github.com/JaesungHuh/voice-gender-classifier (MIT License)
# ECAPA-TDNN gender classifier, VoxCeleb2-finetuned, 98.7% acc on VoxCeleb1 test.
# 实测本项目 57 个老年中文歌声 voice: 96-100% 准确（含 F0=161Hz 低嗓大娘 99% 置信判女）。
# 权重: HF JaesungHuh/voice-gender-classifier (59MB safetensors)，Dockerfile 预下载。
